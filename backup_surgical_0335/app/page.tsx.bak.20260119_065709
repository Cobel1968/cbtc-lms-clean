      ...
      <section className="bg-white shadow-sm border-b" id="courses">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              <option value="all">{language === 'fr' ? 'Toutes catÃƒÆ’Ã‚Â©gories' : 'All categories'}</option>
            ...
            >
              ...
              <option value="beginner">{language === 'fr' ? 'DÃƒÆ’Ã‚Â©butant' : 'Beginner'}</option>
              <option value="intermediate">{language === 'fr' ? 'IntermÃƒÆ’Ã‚Â©diaire' : 'Intermediate'}</option>
              <option value="advanced">{language === 'fr' ? 'AvancÃƒÆ’Ã‚Â©' : 'Advanced'}</option>
            </select>
            ...
            >
              ...
              <option value="price-desc">{language === 'fr' ? 'Prix dÃƒÆ’Ã‚Â©croissant' : 'Price: High to Low'}</option>
              <option value="duration">{language === 'fr' ? 'DurÃƒÆ’Ã‚Â©e' : 'Duration'}</option>
              <option value="rating">{language === 'fr' ? 'Mieux notÃƒÆ’Ã‚Â©s' : 'Highest rated'}</option>
            </select>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center text-blue-600 font-semibold group-hover:gap-2 transition-all">
                  {language === 'fr' ? 'Voir dÃƒÆ’Ã‚Â©tails' : 'View details'}
