...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // 2. Redirect to the Dashboard to trigger the Multi-Dimensional Diagnostic
      // This established the user's initial baseline and Knowledge Gaps
      ...
      <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl shadow-indigo-100 border border-slate-100 overflow-hidden">
        <div className="p-10">
          <div className="flex flex-col items-center mb-8 text-center">
            ...
            <p className="text-slate-400 text-sm font-medium">Create your vocational profile / CrÃƒÂ©er votre profil</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500 font-medium">
              Already have an account? / DÃƒÂ©jÃƒÂ  un compte?{' '}
